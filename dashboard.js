...
function ticketCumpleFiltros(ticket, filtros, excluirCampo = null) {
  ...
  const camposMultiples = ["color", "fechaRegistro", "incidencia", "afectacion", "torre", "estado", "responsable", "dias"];
...
function renderizarTabla(tickets) {
  ...
  tickets.forEach((ticket) => {
    ...
    tr.innerHTML = `
      ...
      <td title="${escapeAttribute(formatearFecha(ticket.FECHA_REGISTRO))}">${escapeHtml(formatearFecha(ticket.FECHA_REGISTRO))}</td>
